import { EventDispatcher } from "../src/data/manage/EventDispatcher";
import { ObserverSubject, Observer } from "../src/data/manage/ObserverSubject";
...
describe("basic: data manage ObserverSubject", () => {
  ...
  test("basic data manage ObserverSubject Observer remove ", () => {
    var obTime = 0;
    var observerSubject = new ObserverSubject();
    var observer1: Observer = {
      update(time: number = 0) {
